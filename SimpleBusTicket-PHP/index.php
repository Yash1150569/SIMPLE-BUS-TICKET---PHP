    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                Hi,This is Yash Labana ,currently pursuing our Bachelor of Technology (BTech) in Information Technology at Manipal University, Jaipur. My academic journey is marked by a shared passion for technology and innovation.
                </p>
            </div>
        </section>
        <!-- Replace your existing "Contact Us" section with this updated version -->

<section id="contact">
    <div id="contact-form">
        <h1>Contact Us</h1>
        <form action="assets/partials/_feedback.php" method="POST">
            <div>
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Simple Bus Ticket Booking System | Made by Yash Labana
                        </p>
        </footer>
    </div>
